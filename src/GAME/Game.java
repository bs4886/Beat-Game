...
public class Game extends JFrame{
	...
	private Image titleImage4 =new ImageIcon(주클래스.class.getResource("../images/캐논 이름.png")).getImage();
	private Image selectedImage4 =new ImageIcon(주클래스.class.getResource("../images/캐논.jpg")).getImage();
	private Image titleImage5 =new ImageIcon(주클래스.class.getResource("../images/로소우제목.png")).getImage();
	private Image selectedImage5 =new ImageIcon(주클래스.class.getResource("../images/로소우.jpg")).getImage();
	...
	//게임창 이미지
	private ImageIcon back1 =new ImageIcon(주클래스.class.getResource("../images/back.png"));
	private ImageIcon back2 =new ImageIcon(주클래스.class.getResource("../images/back 2.png"));
	//게임시작창 이미지들
	...
	//게임시작창 버튼들
		private JButton backBT =new JButton(back1);
	//나가기버튼 창화면 스위치 플래그변수
	...
	//곡선택 버튼들
		...
		//곡선택 >>> 게임화면 변경을위한 변수
		private int isMainScreen=0;  //타이틀이미지
		public  int gameint=0; //게임난이도 
		public  int count=0;//곡순서
		//게임창 이미지를위한 플래그 변수
		...
		public static hit3 hit3=new hit3();
...
//노말버튼 끝
		...
		HardBT.addMouseListener(new MouseAdapter() { //이지 버튼의 액션리스너 시작
			...
			public void mousePressed(MouseEvent e) {
				...
				addKeyListener(new KeyListener3());
...
//하드버튼 끝////
		...
		backBT.addMouseListener(new MouseAdapter() { //뒤로가기 버튼의 액션리스너 시작
			@Override
			public void mouseEntered(MouseEvent e) {
				backBT.setIcon(back2);
	...
	public void paint(Graphics g) {
		...
		imgDraw((Graphics2D)Graphic);
		g.drawImage(img, 0, 0, null);
	} //페인트
	public void imgDraw(Graphics2D g) {
		...
		if(isMainScreen==4) {
			g.drawImage(selectedImage4, 340,170,null);
			g.drawImage(titleImage4, 340, 510,null);
		}if(isMainScreen==5) {
			g.drawImage(selectedImage5, 340,170,null);
			g.drawImage(titleImage5, 340, 500,null);
		}
		...
		if(count==4&&gameint==1) {
			Background=new ImageIcon(주클래스.class.getResource("../images/몽환적배경.jpg")).getImage();
		}
		if(count==4&&gameint==2) {
			Background=new ImageIcon(주클래스.class.getResource("../images/몽환적배경.jpg")).getImage();
		}
		if(count==4&&gameint==3) {
			Background=new ImageIcon(주클래스.class.getResource("../images/몽환적배경.jpg")).getImage();
		}
		if(count==5&&gameint==1) {
			Background=new ImageIcon(주클래스.class.getResource("../images/몽환적배경.jpg")).getImage();
		}
		if(count==5&&gameint==2) {
			Background=new ImageIcon(주클래스.class.getResource("../images/몽환적배경.jpg")).getImage();
		}
		if(count==5&&gameint==3) {
			Background=new ImageIcon(주클래스.class.getResource("../images/몽환적배경.jpg")).getImage();
		}
		if(isGameScreen&&gameint==1) {
			hit.screenDraw(g);
		}
		if(isGameScreen&&gameint==3) {
			hit3.screenDraw3(g);
		}
	...
	public void PlayMusic(int isMainScreen) {
		...
		if(isMainScreen==4) {
			...
			selectedMusic =new Music("캐논 변주곡하이.mp3",true);
			selectedMusic.start();
		...
		if(isMainScreen==5) {
			...
			selectedMusic =new Music("로소우하이.mp3",true);
			selectedMusic.start();
	...
	public void gameStrat(int gameint) {
		...
		if(count==4&&gameint==1) {
			if(GMusic!=null) {GMusic.close();}	
			if(selectedMusic!=null) {selectedMusic.close();}
			GMusic =new Music("캐논 변주곡.mp3",true);
			GMusic.start();
			}
		if(count==4&&gameint==2) {
			if(GMusic!=null) {GMusic.close();}	
