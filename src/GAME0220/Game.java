...
public class Game extends JFrame{
	...
	//곡선택 버튼들
		...
		private int gameint=0; //게임난이도 
		private int count=0;//곡순서
		//게임창 이미지를위한 플래그 변수
...
//하드버튼 끝////
	...
	public void imgDraw(Graphics2D g) {
		...
		if(isGameScreen) {
			g.drawImage(gameRoute, 228,30,null);
			g.drawImage(gameRoute, 332,30,null);
			g.drawImage(gameRoute, 436,30,null);
			g.drawImage(gameRoute, 540,30,null);
			g.drawImage(gameRoute, 640,30,null);
			g.drawImage(gameRoute, 744,30,null);
			g.drawImage(gameRoute, 848,30,null);
			g.drawImage(gameRoute, 952,30,null);
			...
			g.drawString("Space Bar", 580, 570);
